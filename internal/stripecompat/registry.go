...
func DefaultClaims() []Claim {
	...
	add(http.MethodPost, "/v1/invoices/create_preview", Claim{Level: "L3", Stateful: true, Risks: []string{"local subscription-update proration and single-discount subset; taxes, pending invoice items, and full invoice preview parity are not modeled"}})
