...
| G14 Stripe API 90% Program    | In progress    | `docs/STRIPE_COMPATIBILITY_90_TARGET.md` defines 90% L1+ target, current 175/587 baseline, family thresholds, and chunk plan                             |
...
- OpenAPI operation baseline: `175 / 587`, `29.8%`
...
- `go run ./cmd/billtap compatibility inventory --openapi <stripe-openapi-v2261-spec3.json> --output-dir /tmp/billtap-inventory --source stripe/openapi-v2261-2026-04-22.dahlia`
  - result: `operations=587 implemented=175 inventory_only=412 schema_validated=587 implemented_percent=29.8`
