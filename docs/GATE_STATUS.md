...
| G14 Stripe API 90% Program    | In progress    | `docs/STRIPE_COMPATIBILITY_90_TARGET.md` defines 90% L1+ target, current 187/587 baseline, family thresholds, and chunk plan                             |
...
- OpenAPI operation baseline: `187 / 587`, `31.9%`
...
- `go run ./cmd/billtap compatibility inventory --openapi <stripe-openapi-v2261-spec3.json> --output-dir /tmp/billtap-inventory --source stripe/openapi-v2261-2026-04-22.dahlia`
  - result: `operations=587 implemented=187 inventory_only=400 schema_validated=587 implemented_percent=31.9`
