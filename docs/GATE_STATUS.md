...
| G13 Stripe API Expansion      | Planned        | Roadmap defines compatibility levels, endpoint-family priorities, OpenAPI inventory, scorecard expansion, and optional oracle lanes                          |
