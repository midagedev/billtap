...
- move from the current `201 / 587` baseline to at least `529 / 587`
...
```json
{
  ...
  "source": "stripe/openapi v2261",
  "generated_at": "2026-08-29T00:00:00Z",
  "summary": {
    "total_operations": 587,
    "implemented_operations": 201,
    "inventory_only_operations": 387,
    "implemented_percent": 34.2,
    "families": [
      {
        "family": "connect",
        "priority": "P1",
