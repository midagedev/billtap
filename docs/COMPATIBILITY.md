...
| Payment methods         | `GET /v1/payment_methods?customer={id}&type=card`                                                                                                                   | Partial          | Returns a deterministic sandbox card projection for a known customer, including a saved portal default payment method when one was simulated. Create, attach, detach, and general update are not supported.                                                                                                                                                                                                                                                              |
